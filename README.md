...
The following description provides the tips for running comparing WCTE data with WCsim.<br/>
...
4- The notebook and event display of WCTE sim will expect the output directly of convert_to_tuple.c which can be used with root to compile. <br/>
